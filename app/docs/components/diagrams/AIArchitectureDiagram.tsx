...
const nodes: Node[] = [
  // Application Layer
  {
    ...
    style: { ...layerStyle, width: 550, height: 170, background: 'rgba(59, 130, 246, 0.05)' },
  },
  {
    id: 'ai-layer-label',
    position: { x: 70, y: 35 },
    data: { label: 'AI SERVICE LAYER' },
    style: { ...layerStyle, width: 510, height: 115, background: 'rgba(139, 92, 246, 0.08)', border: '1px dashed #8b5cf6' },
  },
  {
    id: 'gemini-analyzer',
    position: { x: 100, y: 80 },
  ...
  // External Services
  {
    ...
    style: { ...layerStyle, width: 550, height: 170, background: 'rgba(16, 185, 129, 0.05)' },
  },
  {
    id: 'gemini-api-label',
    position: { x: 70, y: 255 },
    data: { label: 'GOOGLE GEMINI API' },
    style: { ...layerStyle, width: 510, height: 115, background: 'rgba(16, 185, 129, 0.08)', border: '1px dashed #10b981' },
  },
  {
    id: 'vision-api',
